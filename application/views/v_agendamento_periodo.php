...
<div class="row">
	...
	?>
		...
		<div class="col-md-8 text text-center">
			<h3 class="titulo">Agendamentos para o período de <?= inverteData($dt_inicio) . " a " . inverteData($dt_fim) ?>
			</h3>
		</div>
		...
		?>
			...
			<div id="" class="col-md-6">
				<h3>Não existem agendamentos para o período de
					<?= inverteData($dt_inicio) . " a " . inverteData($dt_fim) ?>.</h3>
			</div>
			<div class="col-md-3"></div>
		<?php } ?>
		</table>
